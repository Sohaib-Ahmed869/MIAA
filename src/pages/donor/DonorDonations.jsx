...
export default function DonorDonations() {
  ...
  return (
    <div>
      ...
      >
        {/* Header */}
        <div className="grid grid-cols-[1fr_auto_auto_auto_auto] gap-4 px-5 py-2 text-[0.5625rem] tracking-[0.2em] uppercase text-accent-cream/30">
          <span>Cause</span>
          <span>Amount</span>
          <span>Status</span>
          <span>Date</span>
        ...
        {donations.map((d) => (
          <motion.div
            ...
            className="grid grid-cols-[1fr_auto_auto_auto_auto] gap-4 items-center px-5 py-3.5 bg-white/[0.03] border border-white/6 rounded-xl hover:bg-white/[0.06] transition-colors"
          >
            <div>
